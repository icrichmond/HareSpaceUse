# import dataset
Forage_KUD_Overlap <- read_csv("input/KUD_Overlap.csv")
view(Forage_KUD_Overlap)

#linear regression 
#scatterplot
scatter.smooth(x=Forage_KUD_Overlap$SH_Alpha_D, y=Forage_KUD_Overlap$Join_Count) 

#create general linear model, parametric test
# paramteric test assumes normality, heterogeneity and independence of residuals
Forage_linearMod <- lm(Forage_KUD_Overlap$Join_Count ~ Forage_KUD_Overlap$SH_Alpha_D) 
# build linear regression model on full data
print(Forage_linearMod)
