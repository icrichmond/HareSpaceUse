...
Figure SD7-1a. Traceplots for our global model.
...
\newpage
Figure SD7-1b. Geweke plots for our global model.
```{r, echo = F, fig.align="center"}
...
\newpage
Figure SD7-2a. Traceplots for our stoichiometry model.
```{r, echo = F, fig.align="center"}
...
\newpage
Figure SD7-2b. Geweke plots for our stoichiometry model.
```{r, echo = F, fig.align="center"}
...
\newpage
Figure SD7-3a. Traceplots for our perceived predation risk model.
```{r, echo = F, fig.align="center"}
...
\newpage
Figure SD7-3b. Geweke plots for our perceived predation risk model.
```{r, echo = F, fig.align="center"}
...
\newpage
Figure SD7-4a. Traceplots for our sex model.
```{r, echo = F, fig.align="center"}
...
\newpage
Figure SD7-4b. Geweke plots for our sex model.
```{r, echo = F, fig.align="center"}
...
\newpage
Figure SD7-5a. Traceplots for our intercept model.
```{r, echo = F, fig.align="center"}
...
\newpage
Figure SD7-5b. Geweke plots for our intercept model.
```{r, echo = F, fig.align="center"}
